! function(e, r) {
  ...
  function f(t, s, u) {
    ...
    return function(e, r, t) {
      e.setAttribute('novalidate', 'true'), f.form = e, f.config = function(e, r) {
        ...
        return [].forEach.call(e.attributes, ((e) => {
          if (/^data-pristine-/.test(e.name)) {
            let s = e.name.substr(14),
              o = s.match(a);
            if (null !== o) {
              const l = void 0 === o[1] ? 'en' : o[1];
      ...
      r = e && !0 === r || !0 === e;
      let t = f.fields;
      !0 !== e && !1 !== e && (e instanceof HTMLElement ? t = [e.pristine] : (e instanceof NodeList || e instanceof(window.$ || Array) || e instanceof Array) && (t = Array.from(e).map(((e) => e.pristine))));
      ...
      e instanceof HTMLElement ? (e.pristine.validators.push({
        ...
        priority: n,
        halt: i
      }), e.pristine.validators.sort(((e, r) => r.priority - e.priority))) : console.warn('The parameter elem must be a dom element');
  ...
  return u('text', {
    ...
    fn: function(e, r) {
      const t = r.match(new RegExp('^/(.*?)/([gimy]*)$'));
    ...
    const n = e.hasOwnProperty(r) ? e[r] : e[r] = {};
